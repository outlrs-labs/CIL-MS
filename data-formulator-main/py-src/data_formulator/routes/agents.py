...
def derive_starter_questions_request():
    ...
    # Manual tables and charts remain usable without an AI provider. Starter
    # suggestions are optional, so do not surface an LLM failure on load when
    # the operator has not configured a server model yet.
