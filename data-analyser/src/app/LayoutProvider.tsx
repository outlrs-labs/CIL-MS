...
import { cilBase } from './cilIntegration';
...
export const LayoutProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const value = useMemo<LayoutContextValue>(() => {
        ...
        // The CIL shell uses a compact 90% density. Use the analyzer's native
        // layout tokens rather than CSS zoom so drag, drop and menu coordinates
        // remain aligned with what Chromium paints.
        const requested = cilBase ? 'compact' : densityPreference === 'auto' ? densityForWidthClass(widthClass) : densityPreference;
